...
export default function Home() {
  ...
  return <View style={styles.safe}><ScrollView refreshControl={<RefreshControl refreshing={busy} onRefresh={load}/>} contentContainerStyle={styles.content}>
    ...
    <View style={styles.quickActions}>
      <QuickAction icon="✅" label="Inspeccionar" onPress={() => router.push('/inspections')}/>
...
const styles = StyleSheet.create({
  ...
  quickActions: { flexDirection: 'row', flexWrap: 'wrap', gap: 9 }, quick: { width: '48.5%', backgroundColor: '#fff', borderWidth: 1, borderColor: theme.colors.line, borderRadius: 16, minHeight: 68, alignItems: 'center', justifyContent: 'center', gap: 3 }, quickIcon: { fontSize: 20 }, quickLabel: { color: theme.colors.ink, fontWeight: '800', fontSize: 11 },
